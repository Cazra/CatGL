 ...
 * @property {uint32} [hex]
 *        Specifies the color as an unsigned 32-bit integer in RGBA format.
 * @property {vec3} [hsb]
...
/**
 * A uniform color. Colors support various types of formats,
...
class Color {
  ...
  /**
   * The color expressed as a 32-bit unsigned integer in RGBA format.
   * @type {uint32}
   */
  get hex() {
